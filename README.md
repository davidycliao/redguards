...
The source code in `replication-code` for replicating the estimates for this paper includes four parts for replication for all tables and figures that appear in both the main paper and the online supplemental materials: i) __tokenization and part-of-speech tagging on Universal Dependencies via pre-trained model__ (01.tokenization-in-udpipe.R) ; ii) __keyword extractions using TextRank__ (02.keywords-extraction.R); and  iii) __scaling documents via Wordfish on the extracted text features__ (03.pooled-ideal-point-estimates.R and 04.incident-ideal-points-estimates.R); last, iiii) __visualizing estimates and ideal points__ (05.visualization.R).  
...
<p align="center">
  <img width="700" height="400" src="https://raw.githack.com/davidycliao/redguards/master/images/network_plot.png" >
</p>
