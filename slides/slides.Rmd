...
### The Source:
- This paper draws on the archive from Chinese Cultural Revolution Database (1966-1976) managed by the Chinese University of Hong Kong under the database named Databases for **the History of Contemporary Chinese Political Movements**. 
...
---
&nbsp;
#### Figure 4: Estimated Positions for the Announcement of New Public Security Regulations
...
---
&nbsp;
#### Figure 4: Estimated Positions for February Countercurrent
```{r echo = F, out.width = "50%"}
